...
<x-app-layout>
    ...
    <div class="mb-6">
        <div class="text-sm text-gray-500 mb-2">
            ...
            <span class="text-gray-500 font-medium">Catégories de matériel</span>
        </div>
        
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            <h1 class="text-2xl font-bold text-gray-900">Catégories de matériel</h1>
                        ...
                        <div class="flex items-center justify-center min-h-screen px-4 text-center sm:p-0">
                            ...
                            <div x-show="showCreateModal" class="relative bg-white rounded-2xl text-left overflow-hidden shadow-xl sm:my-8 sm:max-w-lg w-full p-6">
                                ...
                                <div class="mb-5">
                                    ...
                                    <p class="text-sm text-gray-500 mt-1">Créer une nouvelle famille principale de matériels.</p>
                                </div>
                                ...
                                <form action="{{ route('asset-categories.store') }}" method="POST">
                                    ...
                                    <div class="space-y-4 mb-6">
                                        <div>
                                            <label class="block text-sm font-bold text-gray-900 mb-1">Nom de la catégorie</label>
        ...
        <div class="p-5">
            ...
            <form action="{{ route('asset-categories.index') }}" method="GET" class="flex flex-col sm:flex-row gap-4 items-end">
                ...
                <div class="flex space-x-3 w-full sm:w-auto">
                    ...
                    <a href="{{ route('asset-categories.index') }}" class="w-full sm:w-auto px-6 py-2 bg-white border border-gray-300 text-gray-700 rounded-lg text-sm font-bold hover:bg-gray-50 text-center shadow-sm transition">Réinitialiser</a>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden flex flex-col">
        <div class="p-5 border-b border-gray-100 flex justify-between items-center">
            <h2 class="text-lg font-bold text-gray-900">Liste des catégories</h2>
            ...
            <table class="w-full text-left border-collapse whitespace-nowrap">
                <thead>
                    <tr class="bg-gray-50 border-b border-gray-100">
                        <th class="p-4 text-[10px] font-bold text-gray-500 uppercase tracking-wider">Nom de la catégorie</th>
                ...
                <tbody class="divide-y divide-gray-100">
                                    ...
                                    <div class="flex items-center justify-center min-h-screen px-4 text-center sm:p-0">
                                        ...
                                        <div x-show="showEditModal" class="relative bg-white rounded-2xl overflow-hidden shadow-xl sm:my-8 sm:max-w-lg w-full p-6">
                                            ...
                                            <form action="{{ route('asset-categories.update', $category) }}" method="POST">
                                                ...
                                                <div class="space-y-4 mb-6">
                                                    <div>
                                                        <label class="block text-sm font-bold text-gray-900 mb-1">Nom</label>
                                ...
                                <div x-show="showDeleteModal" style="display: none;" class="fixed inset-0 z-50 overflow-y-auto">
                                    <div class="flex items-center justify-center min-h-screen px-4 text-center sm:p-0">
                                        ...
                                        <div x-show="showDeleteModal" class="relative bg-white rounded-2xl text-left overflow-hidden shadow-xl sm:my-8 sm:max-w-md w-full p-6 text-center">
                                            ...
                                            <p class="text-sm text-gray-500 mt-2 mb-6">Êtes-vous sûr de vouloir supprimer la catégorie <strong>{{ $category->name }}</strong>? Cette action est définitive.</p>
                    ...
                    @empty
                    <tr>
                        <td colspan="2" class="p-6 text-center text-gray-500 text-sm">Aucune catégorie de matériel trouvée.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
