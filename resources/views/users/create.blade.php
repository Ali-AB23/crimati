...
<x-app-layout>
    ...
    <div class="mb-6">
        ...
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            ...
            <p class="text-sm text-gray-500">Create a new internal account. Fields marked <span class="text-red-500">*</span> are required.</p>
        </div>
    </div>
    ...
    <div x-data="{ 
        ...
        <form action="{{ route('users.store') }}" method="POST">
            ...
            <div class="flex justify-end gap-3 mb-6">
                ...
                <button type="submit" class="px-6 py-2.5 bg-green-700 border border-transparent rounded-lg text-sm font-bold text-white hover:bg-green-800 transition shadow-sm">Save</button>
            </div>
                ...
                <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6 md:p-8">
                    ...
                    <div class="space-y-5">
                        ...
                        <div class="grid grid-cols-2 gap-4 pt-2">
                            <div>
                                <label class="block text-sm font-bold text-gray-900 mb-1">Initial password <span class="text-red-500">*</span></label>
                            ...
                            <div>
                                <label class="block text-sm font-bold text-gray-900 mb-1">Confirm password <span class="text-red-500">*</span></label>
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6 md:p-8 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select name="org_unit_id" required class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm text-gray-700">
                            <option value="" disabled selected>Select an org unit...</option>
                ...
                <div class="mt-6 bg-blue-50 border border-blue-100 rounded-lg p-4 flex items-start">
                    ...
                    <p class="text-sm text-blue-700">Office is optional but recommended for better asset visibility.</p>
                </div>
            </div>

            <!-- BARRE D'ACTIONS INFÉRIEURE -->
            <div class="flex justify-between items-center py-4 border-t border-gray-200">
                <button type="reset" class="text-sm font-bold text-red-600 hover:text-red-800 transition">Reset form</button>
