        ...
        <div class="flex items-center justify-center min-h-screen px-4 text-center sm:p-0">
            ...
            <div x-show="showDateModal" class="relative bg-white rounded-2xl text-left overflow-hidden shadow-xl sm:my-8 sm:max-w-md w-full p-6">
                ...
                <div class="flex justify-between items-center mb-5">
                    <h3 class="text-lg font-bold text-gray-900">Edit due date</h3>
                ...
                <form action="{{ route('tickets.update', $ticket) }}" method="POST">
                    ...
                    <div class="mb-6">
                        <label class="block text-[10px] font-bold text-gray-500 uppercase tracking-wider mb-2">Due At</label>
                    ...
                    <div class="flex justify-end space-x-3">
                        <button type="button" @click="showDateModal = false" class="px-4 py-2 bg-white text-gray-700 text-sm font-bold">Cancel</button>
