...
<x-app-layout>
    ...
    <div class="mb-6">
        <div class="text-sm text-gray-500 mb-2">
            ...
            <span class="text-gray-500 font-medium">Unites organisationnelles</span>
        </div>
        
        <div class="flex justify-between items-center">
            <h1 class="text-2xl font-bold text-gray-900">Unites organisationnelles</h1>
            ...
            <div x-data="{ showCreateModal: false }">
                <button @click="showCreateModal = true" class="inline-flex items-center px-4 py-2 bg-green-700 border border-transparent rounded-lg text-sm font-medium text-white hover:bg-green-800 shadow-sm transition">
                    <span class="mr-2 text-lg leading-none">+</span> Add unit
                </button>
                    ...
                    <div x-show="showCreateModal" style="display: none;" class="fixed inset-0 z-50 overflow-y-auto">
                        <div class="flex items-center justify-center min-h-screen px-4 text-center sm:p-0">
                            ...
                            <div x-show="showCreateModal" class="relative bg-white rounded-2xl text-left overflow-hidden shadow-xl sm:my-8 sm:max-w-lg w-full p-6">
                                ...
                                <div class="mb-5">
                                    <h3 class="text-xl font-bold text-gray-900">Add unit</h3>
                                    <p class="text-sm text-gray-500 mt-1">Create a new org unit and optionally assign a parent.</p>
                                </div>
                                ...
                                <form action="{{ route('org-units.store') }}" method="POST">
                                    ...
                                    <div class="space-y-4 mb-6">
                                        ...
                                        <div>
                                            <label class="block text-sm font-bold text-gray-900 mb-1">Type</label>
                                        ...
                                        <div>
                                            <label class="block text-sm font-bold text-gray-900 mb-1">Parent (optional)</label>
                                            ...
                                            <p class="text-[11px] text-gray-400 mt-1">Parent defines hierarchy (parent_id).</p>
                                        </div>
                                    </div>
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm mb-6">
        <div class="px-5 py-4 border-b border-gray-100 flex items-center">
            ...
            <h2 class="text-sm font-bold text-gray-400 uppercase tracking-wider">Search</h2>
        </div>
        ...
        <div class="p-5">
            <form action="{{ route('org-units.index') }}" method="GET" class="flex flex-col md:flex-row gap-4 items-end">
                ...
                <div class="flex space-x-3 w-full md:w-auto">
                    ...
                    <a href="{{ route('org-units.index') }}" class="w-full md:w-auto px-6 py-2 bg-white border border-gray-300 text-gray-700 rounded-lg text-sm font-bold hover:bg-gray-50 text-center shadow-sm transition">Reset</a>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        <div class="p-5 border-b border-gray-100">
            <h2 class="text-lg font-bold text-gray-900">Org units</h2>
        </div>
            ...
            <table class="w-full text-left border-collapse whitespace-nowrap">
                <thead>
                    <tr class="bg-white border-b border-gray-100">
                        <th class="p-4 text-xs font-bold text-gray-600">Name</th>
                        <th class="p-4 text-xs font-bold text-gray-600">Type</th>
                        <th class="p-4 text-xs font-bold text-gray-600">Parent</th>
                        <th class="p-4 text-xs font-bold text-gray-600 text-right">Actions</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-gray-100">
                                        ...
                                        <div x-show="showEditModal" class="relative bg-white rounded-2xl text-left overflow-hidden shadow-xl sm:my-8 sm:max-w-lg w-full p-6">
                                            ...
                                            <form action="{{ route('org-units.update', $unit) }}" method="POST">
                                                ...
                                                <div class="space-y-4 mb-6">
                                                    ...
                                                    <div>
                                                        <label class="block text-sm font-bold text-gray-900 mb-1">Parent</label>
                                                        <select name="parent_id" class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-green-500 sm:text-sm">
                                                            <option value="">-</option>
                                                            @foreach($potentialParents as $parent)
                                ...
                                <div x-show="showDeleteModal" style="display: none;" class="fixed inset-0 z-50 overflow-y-auto">
                                    <div class="flex items-center justify-center min-h-screen px-4 text-center sm:p-0">
                                        ...
                                        <div x-show="showDeleteModal" class="relative bg-white rounded-2xl text-left overflow-hidden shadow-xl sm:my-8 sm:max-w-md w-full p-6 text-center">
                                            ...
                                            <h3 class="text-lg font-bold text-gray-900">Delete unit</h3>
                                            <p class="text-sm text-gray-500 mt-2 mb-6">Are you sure you want to delete <strong>{{ $unit->name }}</strong>? This action cannot be undone.</p>
                    ...
                    @empty
                    <tr>
                        <td colspan="4" class="p-6 text-center text-gray-500 text-sm">No organization units found.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
